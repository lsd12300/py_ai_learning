...
class AsyncToolsExecutor:
    ...
    async def execute_tool_async(self, tool_name: str, input_date: str) -> Dict[str, Any]:
        """异步执行单个工具"""
        loop = asyncio.get_running_loop()

        def _execute():
            return self.tool_registry.execute_tool(tool_name, input_date)
